...
export default function Projects() {
  return (
    <section id="projects" className="py-24 sm:py-32 bg-card/40">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {projects.map((project) => (
            <Card key={project.title} className="group overflow-hidden rounded-xl border border-border/50 bg-background/50 transition-all duration-300 hover:border-primary/50 hover:shadow-glow-accent">
